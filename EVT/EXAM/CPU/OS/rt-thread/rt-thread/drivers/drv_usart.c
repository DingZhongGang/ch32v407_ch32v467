...
static struct ch32_uart_hw_config uart_hw_config[] =
{
...
#ifdef BSP_USING_UART2
    {
        ...
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOD, GPIO_Pin_5, /* Tx */GPIOD, GPIO_Pin_6, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32v30x_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART4, RCC_PB2Periph_GPIOC,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART5, RCC_PB2Periph_GPIOC|RCC_APB2Periph_GPIOD,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART6, RCC_PB2Periph_GPIOC,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART7, RCC_PB2Periph_GPIOC,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART8, RCC_PB2Periph_GPIOC,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART9, RCC_PB2Periph_GPIOB,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOB, GPIO_Pin_1, /* Tx */GPIOB, GPIO_Pin_2, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32v30x_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
    ...
    {
        /* clock configuration, please refer to ch32v30x_rcc.h */
        RCC_PB1Periph_USART10, RCC_PB2Periph_GPIOB,
        /* GPIO  configuration : TX_Port,TX_Pin, RX_Port,RX_Pin */
        GPIOE, GPIO_Pin_0, /* Tx */GPIOE, GPIO_Pin_1, /* Rx */
        /* Whether to enable port remapping, you can refer to ch32v30x_gpio.h file,
        for example, USART1 needs to be turned on, you can use GPIO_Remap_USART1 */
        GPIO_Remap_NONE,
    },
...
#ifdef BSP_USING_UART1
#if defined (SOC_RISCV_SERIES_CH32V4)
...
#ifdef BSP_USING_UART9
#if defined (SOC_RISCV_SERIES_CH32V4)
void USART9_IRQHandler(void) __attribute__((interrupt()));
#else
void USART9_IRQHandler(void) __attribute__((interrupt("WCH-Interrupt-fast")));
#endif
...
#ifdef BSP_USING_UART10
#if defined (SOC_RISCV_SERIES_CH32V4)
void USART10_IRQHandler(void) __attribute__((interrupt()));
#else
void USART10_IRQHandler(void) __attribute__((interrupt("WCH-Interrupt-fast")));
#endif
